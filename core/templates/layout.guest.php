...
<!--[if !IE]><!--><html class="ng-csp" data-placeholder-focus="false"><!--<![endif]-->
	...
	<body id="body-login">
		...
		<footer><p class='info' style='width: auto !important;'><a href='http://www.turnkeylinux.org/owncloud'>ownCloud Appliance</a> &ndash; Powered by <a href='http://www.turnkeylinux.org'>TurnKey Linux</a></p></footer>
			<p class="info">
